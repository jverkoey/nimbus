...
@protocol NIPickerTextFieldDelegate <NISearchTextFieldDelegate>

@optional

- (void)textField:(NIPickerTextField*)textField didAddCellAtIndex:(NSInteger)index;

- (void)textField:(NIPickerTextField*)textField didRemoveCellAtIndex:(NSInteger)index;
